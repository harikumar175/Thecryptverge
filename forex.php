...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="mainpage2.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-line-chart fa-fw "></i>  Top Active</a>
    ...
    <a href="forex.php" class="w3-bar-item w3-button w3-padding w3-light-green"><i class="fa fa-cubes fa-fw"></i>  Forex Stream</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:50px;">
  ...
  <!-- Header -->
  <!-- TradingView Widget BEGIN -->
  <h2 style="padding-left:22px">Forex Cross Rates</h2>
...
<br>
<h2 style="padding-left:22px">Forex Heat map</h2>
<!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container" style="padding-left:22px">
  <div class="tradingview-widget-container__widget"></div>
